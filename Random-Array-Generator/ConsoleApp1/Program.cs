...
namespace CSharp_Array_Algorithms
{
    internal class Program
    {
        ...
        public static (int min, int max) FindMinAndMax(IReadOnlyList<int> numbers)
        {
            if (numbers.Count == 0)
        ...
        public static int CalculateSum(IReadOnlyList<int> numbers)
        {
            int sum = 0;
        ...
        public static int[] CopyArray(IReadOnlyList<int> numbers)
        {
            int[] copy = new int[numbers.Count];
            for (int i = 0; i < numbers.Count; i++)
            {
                copy[i] = numbers[i];
            }
        ...
        public static List<int> FindPrimes(IReadOnlyList<int> numbers)
        {
        ...
        public static void ShowArray(IReadOnlyCollection<int> array, string message)
        {
            ...
            Console.WriteLine("\n");
            Console.WriteLine(new string('*', Math.Min(array.Count * 10, 80)));
        }
        public static int[] ZipTwoArrays(IReadOnlyList<int> array1, IReadOnlyList<int> array2)
        {
        ...
        public static int FindIndexOf(IReadOnlyList<int> array, int value)
        {
        ...
        public static bool IsPalindrome(IReadOnlyList<int> digits)
        {
